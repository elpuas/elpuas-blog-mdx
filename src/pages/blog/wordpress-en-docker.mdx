...
![WordPress Docker](https://www.elpuas.com/wp-content/uploads/2018/12/FI-1-1024x480.jpg)

Las herramientas para desarrollar sitios de WordPress localmente ha cambiado con los años. Primero,  WAMP,  XAMP,  Bitnami, hasta que hice un presupuesto para una Mac y encontré MAMP, mas adelante con  LOCALbyFlywheel y ¡Entonces vino Vagrant!

Cuando llegó Docker, rápidamente lo agarré por las riendas y probé la mierda en todo tipo de casos, me parecio rapido, facil de usar y sobretodo liviano.
...
Vamos a entrar en detalles ... pero primero, asegúrate de tener [Docker instalado](https://hub.docker.com/editions/community/docker-ce-desktop-mac)

![Docker](https://i1.wp.com/www.elpuas.com/wp-content/uploads/2018/12/IMG2.jpg)

## Configurar docker-compose

Antes de continuar, necesito decir algo. Puedes copiar y pegar estos snippets todo el día y te funcionaran tal como estan. Puedes usarlos de prueba y error para hacer que algo funcione, pero hasta que realmente leas la documentación en [docker](https://docs.docker.com/engine/reference/commandline/) o en [docker-compose](https://docs.docker.com/compose/overview/), probablemente no podrás personalizar y hackear tu propio proceso. Dicho esto, aquí vamos.
...
Para saber mas  sobre todo lo que puedes hacer con Docker visita la [página oficial.](https://docs.docker.com/compose/)

## Qué más podemos hacer con Docker?

![Docker](https://i0.wp.com/www.elpuas.com/wp-content/uploads/2018/12/IMG3.jpg)
...
Si te gusto este post o crees que puede ayudar a alguien como tu, por favor compartelo! [escribeme](https://www.elpuas.com/contact/) y hazme saber tus comentarios.
